...
use Bee\Client\Exception\ConnectionException;
use Bee\Client\Exception\Exception;
use Bee\Client\Packer\PackUtils;
use Bee\Client\Tests\Assert;
use Bee\Client\Tests\GreetingDataProvider;
use Bee\Client\Tests\Integration\FakeServer\FakeServerBuilder;
use Bee\Client\Tests\Integration\FakeServer\Handler\ChainHandler;
use Bee\Client\Tests\Integration\FakeServer\Handler\NoopHandler;
use Bee\Client\Tests\Integration\FakeServer\Handler\ReadHandler;
use Bee\Client\Tests\Integration\FakeServer\Handler\SocketDelayHandler;
use Bee\Client\Tests\Integration\FakeServer\Handler\WriteHandler;
...
class ConnectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @group tcp_only
     * @expectedException \Bee\Client\Exception\ConnectionException
     */
    ...
    public function testParseGreetingWithInvalidServerName($greeting)
    {
        ...
        try {
            ...
            $this->assertSame(
                '' === $greeting ? 'Unable to read greeting.' : 'Invalid greeting: unable to recognize Bee server.',
                $e->getMessage()
            );
